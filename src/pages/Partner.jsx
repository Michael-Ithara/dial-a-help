...
export default function Partner() {
  return (
    ...
    <motion.main
      className="pt-24 px-6 pb-12 max-w-2xl mx-auto space-y-10"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      ...
      >
        ...
        <label className="flex flex-col gap-1">
          ...
          <input
            ...
            name="organization"
            required
            className="p-3 border border-gray-300 dark:border-gray-700 rounded focus:outline-emerald-500"
          />
        </label>
        ...
        <label className="flex flex-col gap-1">
          ...
          <select
            ...
            required
            className="p-3 border border-gray-300 dark:border-gray-700 rounded bg-white dark:bg-gray-800"
          >
        ...
        <button
          type="submit"
          className="mt-4 bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-6 rounded-full transition"
        >
