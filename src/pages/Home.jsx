...
export default function Home() {
  return (
      <motion.main
        {...pageFade}
        className="pt-24 space-y-24 text-gray-900 dark:bg-gray-900 dark:text-gray-100 min-h-screen"
      >
        {/* Hero Section */}
        <motion.section
          initial="hidden"
        ...
        >
          <motion.h1
            variants={fadeUp}
            custom={0}
            className="text-5xl font-extrabold text-emerald-600 leading-tight"
          >
          ...
          >
            ...
            <Link to="/about">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
                className="border border-emerald-600 text-emerald-600 px-6 py-3 rounded-full hover:bg-emerald-50 transition"
              >
                Learn More
              </motion.button>
            </Link>
        ...
        <motion.section
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto px-6"
        >
          {[
            ...
            >
              <h3 className="text-3xl font-bold text-emerald-600">{stat.value}</h3>
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          variants={fadeUp}
          className="bg-amber-50 dark:bg-gray-800 py-16 px-6 text-center rounded-lg shadow-inner"
        >
          <motion.h2
            variants={fadeUp}
            custom={0}
